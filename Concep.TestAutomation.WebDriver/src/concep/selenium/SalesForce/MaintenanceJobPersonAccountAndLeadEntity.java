...
public class MaintenanceJobPersonAccountAndLeadEntity extends BaseSFDC {
    ...
    public void successfullyKeppAllSurveyMappingsAfterMaintenanceJobExecutionOnlyLeadQuestionsMapped() throws Exception {
        ...
        log.startTest( "Verify that survey keeps all its mappings after the execution of the Maintenance job and only Person Account entity questions are mapped" );
        try {
    ...
    @Test(groups = { "all-tests", "maintenance-job", "key-tests" })
    public void successfullyKeppAllSurveyMappingsAfterMaintenanceJobExecutionOnlyPersonAccountQuestionsMapped() throws Exception {
    ...
    @Test(groups = { "all-tests", "maintenance-job", "key-tests" })
    public void successfullyKeppAllSurveyMappingsAfterMaintenanceJobExecutionPersonAccountAndLeadQuestionsMapped() throws Exception {

    	String randNumber = driver.getTimestamp();
        String surveyName = randNumber + "surveyName";
         
        log.startTest( "Verify that survey keeps all its mappings after the execution of the Maintenance job - Person Account and Lead entity questions are mapped" );
        try {
