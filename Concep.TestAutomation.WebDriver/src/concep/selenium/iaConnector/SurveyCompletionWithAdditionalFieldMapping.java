...
public class SurveyCompletionWithAdditionalFieldMapping extends BaseIAconnector {
        ...
        try {
            ...
            loginToSend().goToSurveyPage().iaSurvey.createSurveyAndTypeSurveyName( surveyName )
                                                   .selectSurveyFolders( surveyType,
                                                                         eventFolder ).iaQuestion.editFTQAndMapItToEmail( false );
            ...
            if( isMultipleChoice ) {
                par.additionalFields.questions.add( mcContactFiled.name );
            } else {
                par.additionalFields.questions.add( ftContactField.conntactFiled );
            }
            if( isCompanyMapped ) {
            ...
            if( isMultipleChoice ) {
                par.additionalFields.answers.add( mcContactFiled.option_1 );
            } else {
                par.additionalFields.answers.add( "Programming" );
            }
            if( isCompanyMapped ) {
                par.additionalFields.answers.add( companyName );
            }
    ...
    private void completeSurveyWithMappingMultipleQuestionToFieldTypeListAndFreeText(
        ...
        if( isCompanyMapped ) {
            ...
            log.startTest( "Verify that Survey Type '" + surveyType + "' with Interaction Folder '"
                           + eventFolder
        ...
        try {
            ...
            // Save and deploy survey
            send.iaSurvey.saveAndSelectTheme( theme )
            ...
            par.additionalFields.questions.add( MCcontactFiled.COLORGLOBAL.name );
            par.additionalFields.questions.add( MCcontactFiled.GENDERLOCAL.name );
            par.additionalFields.questions.add( MCcontactFiled.COLORLOCAL.name );
            par.additionalFields.questions.add( FTcontactField.HOBBYGLOBAL.conntactFiled );
            par.additionalFields.questions.add( FTcontactField.LASTNAME.conntactFiled );
            par.additionalFields.questions.add( FTcontactField.EMPLOYEEGLOBAL.conntactFiled );
            par.additionalFields.questions.add( FTcontactField.HOBBYLOCAL.conntactFiled );
            par.additionalFields.questions.add( FTcontactField.EMPLOYEELOCAL.conntactFiled );
            if( isCompanyMapped ) {
                par.additionalFields.questions.add( FTcontactField.COMPANY.conntactFiled );
            }

            par.additionalFields.answers.add( MCcontactFiled.GENDERGLOBAL.option_1 );
            par.additionalFields.answers.add( MCcontactFiled.GENDERLOCAL.option_2 );
            par.additionalFields.answers.add( MCcontactFiled.GENDERLOCAL.option_1 );
            par.additionalFields.answers.add( MCcontactFiled.GENDERGLOBAL.option_2 );
            par.additionalFields.answers.add( "Programming" );
            par.additionalFields.answers.add( "Programming" );
            par.additionalFields.answers.add( emailAddress );
            par.lastName.add( lastName );
    ...
    private void completeSurveyWithMappingMultipleQuestionToFieldTypeListWithMultipleValues(
        ...
        log.startTest( "successfully completed surveywebDriver.type '" + surveyType + "' in '" + eventFolder
        ...
        try {
            ...
            send.iaSurvey.saveAndSelectTheme( theme )
                         .viewAndDeployTheSurvey().iaQuestion.answerFtQuestion( FTcontactField.HOBBYGLOBAL.question,
                                                                                "Programming" )
                                                             .answerFtQuestion( FTcontactField.LASTNAME.question,
                                                                                lastName )
                                                             .answerFtQuestion( FTcontactField.EMAIL.question,
            ...
            par.additionalFields.answers.add( "Programming" );
            par.additionalFields.answers.add( emailAddress );
            par.additionalFields.answers.add( MCcontactFiled.COLORGLOBAL.option_1 );
            par.additionalFields.answers.add( MCcontactFiled.COLORGLOBAL.option_2 );
            par.additionalFields.answers.add( MCcontactFiled.COLORLOCAL.option_1 );
            par.additionalFields.answers.add( MCcontactFiled.COLORLOCAL.option_2 );
            par.lastName.add( lastName );
            par.folderName = eventFolder;
    ...
    public void successfullyCompletedSurveyMarkitngListNoSponsorFolderMultipleQuestionsLinkedToGFAndLFNewContact() throws Exception {
    ...
    public void successfullyCompletedSurveyTypeMarkitngListSponsorfolderMultipleQuestionLinkedToGFAndLFNewContact() throws Exception {
    ...
    public void successfullyCompletedSurveyTypeAdministrativefolderMultipleQuestionsLinkedToGFAndLFNewContact() throws Exception {
     ...
     */
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyMarkitngListNoSponsorFolderMultipleQuestionsLinkedToGFAndLFNewCompany() throws Exception {
    ...
    /**
         ...
         */
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyTypeAdministrativefolderMultipleQuestionsLinkedToGFAndLFNewCompnay() throws Exception {
    ...
    /**
        ...
        */
    @Test(groups = { "survey-completion", "all-tests", "smoke-tests" })
    public void successfullyCompletedSurveyTypeMarkitngListSponsorfolderMultipleQuestionLinkedToGFAndLFNewCompany() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyNoSponsorContactOnlyFolderMultipleQuestionsLinkedToGFAndLFNewContact() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyTypeSponsorContactOnlyFolderMultipleQuestionLinkedToGFAndLFNewContact() throws Exception {
     ...
     */
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyTypeRegistrationMarkitngListSponsorIAfolderMCQuestionLinkedToGFNewContact() throws Exception {
     ...
     */
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedFeedbackSurveyMarkitngListNoSponsorFolderMCQuestionLinkedToGFNewContact() throws Exception {
     ...
     */
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedFeedbackSurveyMarkitngListNoSponsorFolderMCQuestionLinkedToLFNewContact() throws Exception {
     ...
     */
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyTypeRegistrationMarkitngListSponsorIAfolderMCQuestionLinkedToLFNewContact() throws Exception {
     ...
     */
    @Test(groups = { "survey-completion", "all-tests", "smoke-tests" })
    public void successfullyCompletedFeedbackSurveyMarkitngListNoSponsorFolderFTQuestionLinkedToGFNewContact() throws Exception {
     ...
     */
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyTypeRegistrationMarkitngListSponsorIAfolderFTQuestionLinkedToGFNewContact() throws Exception {
     ...
     */
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedFeedbackSurveyMarkitngListNoSponsorFolderFTQuestionLinkedToLFNewContact() throws Exception {
     ...
     */
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyTypeRegistrationMarkitngListSponsorIAfolderFTQuestionLinkedToLFNewContact() throws Exception {
     ...
     */
    @Test(groups = { "survey-completion", "all-tests", "smoke-tests" })
    public void successfullyCompletedFeedbackSurveyMarkitngListNoSponsorFolderFTQuestionLinkedToGFNewContactNewCompany() throws Exception {
    ...
    */
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedFeedbackSurveyMarkitngListNoSponsorFolderFTQuestionLinkedToLFNewContactNewCompany() throws Exception {
    ...
    /**
        ...
        */
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedFeedbackSurveyMarkitngListNoSponsorFolderMCQuestionLinkedToGFNewContactNewCompany() throws Exception {
    ...
    /**
        ...
        */
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedFeedbackSurveyMarkitngListNoSponsorFolderMCQuestionLinkedToLFNewContactNewCompany() throws Exception {
    ...
    /**
        ...
        */
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyTypeRegistrationMarkitngListSponsorIAfolderFTQuestionLinkedToGFNewContactNewCompany() throws Exception {
    ...
    */
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyTypeRegistrationMarkitngListSponsorIAfolderFTQuestionLinkedToLFNewContactNewCompany() throws Exception {
    ...
    /**
         ...
         */
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyTypeRegistrationMarkitngListSponsorIAfolderMCQuestionLinkedToGFNewContactNewCompany() throws Exception {
    ...
    /**
         ...
         */
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyTypeRegistrationMarkitngListSponsorIAfolderMCQuestionLinkedToLFNewContactNewCompany() throws Exception {
    ...
    */
    ...
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedFeedbackSurveyNoSponsorContactOnlyFolderFTQuestionLinkedToGFNewContact() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedFeedbackSurveyNoSponsorContactOnlyFolderFTQuestionLinkedToLFNewContact() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedFeedbackSurveyNoContactOnlySponsorFolderMCQuestionLinkedToGFNewContact() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedFeedbackSurveyNoSponsorContactOnlyFolderMCQuestionLinkedToLFNewContact() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyTypeRegistrationSponsorContactOnlyIAfolderFTQuestionLinkedToGFNewContact() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyTypeRegistrationSponsorContactOnlyIAfolderFTQuestionLinkedToLFNewContact() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyTypeRegistrationSponsorContactOnlyIAfolderMCQuestionLinkedToGFNewContact() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyTypeRegistrationSponsorContactOnlyIAfolderMCQuestionLinkedToLFNewContact() throws Exception {
    ...
    */
    ...
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyNoSponsorContactOnlyFolderMultipleQuestionsLinkedToGFAndLFNewCompanyMustNotCreated() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyNoSponsorContactOnlyFolderMultipleQuestionsLinkedToGFAndLFNewCompanyAndContactMustNotCreated() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyNoSponsorFolderMultipleQuestionsLinkedWithMultipleValuesToNewContact() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyNoSponsorContactOnlyFolderMultipleQuestionsLinkedWithMultipleValuesToNewContact() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyTypeSponsorfolderMultipleQuestionLinkedWithMultipleValuesToNewContact() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyTypeSponsorContactOnlyFolderMultipleQuestionLinkedWithMultipleValuesToNewContact() throws Exception {
