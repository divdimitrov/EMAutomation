...
public class SurveyCompletion extends BaseIAconnector {
    ...
    private void setConnectionConfiguration() throws Exception {
		...
		//.addUsers(sendAccounts) TODO permissions have to be set
    ...
    private void successfullyUpatingExistingContacts(
        ...
        try {
            ...
            if( isCompany ) {
                ...
                par.lastName.add( lastName + "updated" );
                answersArray.add( emailAddress );
                answersArray.add( firstName );
    ...
    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveyTypeAdministrativeContactOnlyfolderWithExistingCompnay() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyNoSponsorFolderWithExistingContactInConnectionSearchFolder() throws Exception {

        successfullyUpatingExistingContacts( "contact in " + seachPeopleFolder + " contact must be updated",
                                             false,
                                             surveyType3,
                                             eventFolderNoSponsor,
                                             seachPeopleFolder );
    ...
    @Test(groups = { "survey-completion", "all-tests", "key-tests" })
    public void successfullyCompletedSurveyTypeSponsorfolderWithExistingCompanyInConnectionSearchFolder() throws Exception {

        successfullyUpatingExistingContacts( "Company in" + searchCompaniesFolder
                                             + " company must be linked to the contact",
                                             true,
                                             surveyType2,
                                             eventFolderWithSponsor,
                                             searchCompaniesFolder );
    }

    @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompletedSurveySponsorFolderWithExistingContactInIaButNotInSourceFolder() throws Exception {

        successfullyUpatingExistingContacts( "contact in " + eventFolderNoSponsor + " not in "
                                             + eventFolderWithSponsor + " new contact must be created",
                                             false,
                                             surveyType3,
                                             eventFolderWithSponsor,
                                             eventFolderNoSponsor );
    ...
    public void successfullyCompletedSurveyWith10MappedQuestions() throws Exception {
        ...
        try {
            ...
            for( int i = 3; i <= 9; i++ ) {
                ...
                if( interactionField[i].equals( "Primary Email" )
                    || interactionField[i].equals( "Last Name" ) )
                    continue;
    ...
    public void successfullyCompletedSurveyWith10Pages() throws Exception {
        ...
        try {
            ...
            //Go to Survey Page.
            loginToSend().goToSurveyPage().iaSurvey.createSurveyAndTypeSurveyName( surveyName )
                                                   .selectSurveyFolders( surveyType2,
                                                                         eventFolderWithSponsor );
    ...
    public void successfullyCompletedSurveyWith5TypesOfQuestions() throws Exception {
        ...
        try {
            ...
            //Go to Survey Page.
            loginToSend().goToSurveyPage().iaSurvey.createSurveyAndTypeSurveyName( surveyName )
                                                   .selectSurveyFolders( surveyType4,
                                                                         eventFolderWithSponsor );
            ...
            driver.type( "//div[@id='qRowList']/div[1]//input[@type='text']", matrixValue1, driver.timeOut );
            log.endStep();

            log.startStep( "Add value to the second row" );
            driver.type( "//div[@id='qRowList']/div[2]//input[@type='text']", matrixValue2, driver.timeOut );
            log.endStep();

            log.startStep( "Add value to the first column" );
            driver.type( "//div[@id='qColumnList']/div[1]//input[@type='text']", matrixValue3, driver.timeOut );
            log.endStep();

            log.startStep( "Add value to the second column" );
            driver.type( "//div[@id='qColumnList']/div[2]//input[@type='text']", matrixValue4, driver.timeOut );
            log.endStep();
    ...
    public void successfullyCompletedSurveyWithDragAndDropQuestionsOnly() throws Exception {
        ...
        try {
            ...
            send.iaSurvey.saveAndSelectTheme( Theme.RED.type )
                         .viewAndDeployTheSurvey().iaQuestion.answerMcQuestion( MCcontactFiled.COLORGLOBAL.question,
    ...
    public void successfullyCompletedSurveyWithLoginAs() throws Exception {
        ...
        try {
            ...
            send.iaSurvey.saveAndSelectTheme( Theme.FUNKY.type )
                         .viewAndDeployTheSurvey().iaQuestion.answerMcQuestion( MCcontactFiled.COLORGLOBAL.question,
                                                                                new String[]{ MCcontactFiled.COLORGLOBAL.option_1 } )
                                                             .answerFtQuestion( FTcontactField.EMAIL.question,
                                                                                emailAddress )
    ...
    private void successfullyCompletedSurveyWithoutAnsweringAllQuestions(
                                                                          String testDescription,
                                                                          boolean isMCMapped,
                                                                          boolean isFTMapped ) throws Exception {
    ...
    public void successfullyCompletedSurveyWithRSVPQuestion() throws Exception {
        ...
        try {
            ...
            /* driver.click( "//li[1][@class='s_clear answerItem']//label[@title='Accept']/input",
                          driver.timeOut );*/            
            driver.select( "//div[@id='qAnswersList']//div[contains(@class, 'qAnswerRow')][1]//div[@class='acceptOrDecline']//select" )
            .selectByVisibleText( "Accept" );
            log.endStep();
            ...
            /*driver.click( "//li[2][@class='s_clear answerItem']//label[@title='Decline']/input",
                          driver.timeOut );*/
            driver.select( "//div[@id='qAnswersList']//div[contains(@class, 'qAnswerRow')][2]//div[@class='acceptOrDecline']//select" )
            .selectByVisibleText( "Decline" );
            log.endStep();
        ...
        try {
            ...
            for( int i = 0; i < specialCharacters.length; i++ ) {
                ...
                send.iaSurvey.viewAndDeployTheSurvey().iaQuestion.answerMcQuestion( MCcontactFiled.GENDERGLOBAL.question,
                                                                                    new String[]{ MCcontactFiled.GENDERGLOBAL.option_1 } )
                                                                 .answerFtQuestion( FTcontactField.EMAIL.question,
                                                                                    emailLocalPart + specialCharacters[i]
                                                                                                                   + emailDomainPart )
                                                                 .answerFtQuestion( FTcontactField.LASTNAME.question,
                                                                                    lastName );
                send.iaSurvey.surveyNext();
                ...
                for( int j = 0; j < questionsArray.size(); j++ ) {
                    ...
                    par.additionalFields.questions.add( questionsArray.get( j ) );
                }

                for( int j = 0; j < answersArray.size(); j++ ) {

                    par.additionalFields.answers.add( answersArray.get( j ) );
                }
    ...
    public void successfullyCompletedSurveyWithDifferentSpecialCharactersInCompanyName() throws Exception {
        ...
        String surveyNumber = driver.getTimestamp();
        String lastName = surveyNumber + "lastName";
        String surveyName = surveyNumber + "DifferentSpecialCharactersInCompanyName";
        String number = driver.getTimestamp();
        String emailLocalPart = number + "testemail";
        String emailDomainPart = "@concep.com";
        String companyNameFirstPart = "company";
        String companyNameSecondPart = "Ltd";

        log.startTest( "Verify that survey must be completed successfully when email contains special legal characters in the company name" );
        ...
        try {
            ...
            for( int i = 0; i < specialCharacters.length; i++ ) {
                ...
                send.iaSurvey.viewAndDeployTheSurvey().iaQuestion.answerMcQuestion( MCcontactFiled.GENDERGLOBAL.question,
                                                                                    new String[]{ MCcontactFiled.GENDERGLOBAL.option_1 } )
                                                                 .answerFtQuestion( FTcontactField.EMAIL.question,
                                                                                    emailLocalPart + i + emailDomainPart )
                                                                 .answerFtQuestion( FTcontactField.LASTNAME.question,
                                                                                    lastName )
                                                                 .answerFtQuestion( FTcontactField.COMPANY.question,
                                                                                    companyNameFirstPart + specialCharacters[i]
                                                                                                                     + companyNameSecondPart );
                send.iaSurvey.surveyNext();
    ...
    public void successfullyCompletedReopenedSurveyMappingWarningMessageVerification() throws Exception {
        ...
        try {
            ...
            log.endStep( driver.isSelected( "//select[@id='surveyInteractionFolder']",
                                            eventFolderWithSponsor ) );
    ...
    public void successfullyCompletedSurveyWithMCQWithDropDown() throws Exception {
        ...
        try {
            ...
            send.iaSurvey.saveAndSelectTheme( Theme.WATER.type )
                         .viewAndDeployTheSurvey().iaQuestion.answerDropDownQuestion( MCcontactFiled.GENDERGLOBAL.question,
    ...
    public void successfullyCompletedSurveyWithPageJumping() throws Exception {
        ...
        try {
            ...
            log.startStep("Click on the 'More Options' hyperlink");
            driver.click("(//div[@id='qAnswersList']//a[@class='qAnswerMoreOptions'])[1]", driver.timeOut);
            log.endStep();
            
            log.startStep( "Map the MCQ answers to Pages" );
            driver.select( "//div[@id='qAnswersList']//div[1]//select[contains(@class, 'qPagelist')]" ).selectByVisibleText( "Page 3" );
            driver.select( "//div[@id='qAnswersList']//div[2]//select[contains(@class, 'qPagelist')]" ).selectByVisibleText( "Page 4" );
            log.endStep();
            ...
            log.startStep( "Map the MCQ answers to Pages" );
            driver.select( "//div[@id='qAnswersList']//div[1]//select[contains(@class, 'qPagelist')]" ).selectByVisibleText( "Page 5" );
            driver.select( "//div[@id='qAnswersList']//div[2]//select[contains(@class, 'qPagelist')]" ).selectByVisibleText( "Page 4" );
            log.endStep();
            ...
            // Save and deploy survey
            send.iaSurvey.saveAndSelectTheme( "Survey" )
                         .viewAndDeployTheSurvey().iaQuestion.answerMcQuestion( MCcontactFiled.COLORGLOBAL.question,
                                                                                new String[]{ MCcontactFiled.COLORGLOBAL.option_1 } )
                                                             .answerFtQuestion( FTcontactField.EMAIL.question,
                                                                                emailAddress )
    ...
    public void successfullyCompletedSurveyWithContentQuestionWithLink() throws Exception {
        ...
        try {
            ...
            send.iaSurvey.iaQuestion.updateQuestion();
            send.iaSurvey.saveAndSelectTheme( "Water" )
                         .viewAndDeployTheSurvey().iaQuestion.answerMcQuestion( MCcontactFiled.GENDERGLOBAL.question,
                                                                                new String[]{ MCcontactFiled.GENDERGLOBAL.option_1 } )
                                                             .answerFtQuestion( FTcontactField.EMAIL.question,
                                                                                emailAddress )
    ...
    private void submitSurveyWithMultipleLanguages(
        ...
        try {
            ...
            for( int i = 0; i < ( languages.length ) - 1; i++ ) {
                ...
                send.iaSurvey.goToSurveyLanguagePage( languages[i + 1] ).iaQuestion
                                                                                   .editQuestionType( FTcontactField.EMAIL.question )
    ...
    //@Test(groups = { "survey-completion", "all-tests", "smoke-tests" })
    public void successfullyCompleteMLVSurveyNotExistingPersonButExistingCompanyWithPrimrayLanguageOnly() throws Exception {
    ...
    //@Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyNotExistingPersonButExistingCompanyWithPrimaryAndOtherLanguages() throws Exception {
    ...
    //@Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyExistingPersonOnlyPrimaryLanguageAndCompanyWithMatchingPrimrayLanguage() throws Exception {
    ...
    //@Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyExistingPersonOnlyPrimaryLanguageAndCompanyWithNotMatchingPrimrayLanguages() throws Exception {
    ...
    //@Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyExistingPersonOnlyPrimaryLanguageAndCompanyWithAtLeastOneOtherLanguageNoMatches() throws Exception {
    ...
    //@Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyExistingPersonOnlyPrimaryLanguageAndCompanyWithAtLeastOneOtherLanguageMatches() throws Exception {
    ...
    //@Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyExistingPersonOnlyPrimaryLanguageAndNotExistingCompany() throws Exception {
    ...
    // @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyExistingPersonAtLeastOneOtherLanguageAndCompanyMatchingPrimrayLanguage() throws Exception {
    ...
    //@Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyExistingPersonAtLeastOneOtherLanguageAndCompanyNotMatchingPrimrayLanguage() throws Exception {
    ...
    //@Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyExistingPersonAndCompanyWithAtLeastOneOtherLanguagesNotMatching() throws Exception {
    ...
    // @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyExistingPersonAndCompanyWithAtLeastOneOtherLanguagesMatchingToPrimary() throws Exception {
    ...
    //@Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyExistingPersonAndCompanyWithAtLeastOneOtherLanguagesMatching() throws Exception {
    ...
    // @Test(groups = { "survey-completion", "all-tests" })
    public void successfullyCompleteMLVSurveyExistingPersonWithAtLeastOneOtherLanguagesAndNotExistingCompany() throws Exception {
    ...
    public void successfullyLogHighestIDQuestionEnteredValueToCrmDuplicatedQuestionMappingsSamePage() throws Exception {
        ...
        try {
            ...
            for( int i = 0; i < submissionsCount; i++ ) {
                ...
                par.lastName.add( ( duplicatedFTQids.get( send.iaSurvey.iaQuestion.getHighesQuestionId( duplicatedFTQids ) ) ) );
    ...
    public void successfullyLogHighestIDQuestionEnteredValueToCrmDuplicatedQuestionMappingsSamePageMultipleAnswersEnabled() throws Exception {
    ...
    @Test(groups = { "survey-completion", "all-tests", "smoke-tests", "mappings-duplication", "key-tests" })
    public void successfullyLogHighestIDQuestionEnteredValueToCrmDuplicatedQuestionMappingsDifferentPages() throws Exception {
    ...
    public void successfullyCompleteSurveyWithNotMappedFTQs() throws Exception {
        ...
        try {
            ...
            loginToSend().goToSurveyPage().iaSurvey.createSurveyAndTypeSurveyName( surveyName )
                                                   .selectSurveyFolders( surveyType1,
                                                                         eventFolderWithSponsor ).iaQuestion.addFTQAndMapItToLastName( false )
                                                                                                            .addFTQAndMapItToEmail( false )
    ...
    public void successfullyCompleteSurveyWithNotMappedMCQOnlyMappedToCampaignResponse() throws Exception {
        ...
        try {
            ...
            loginToSend().goToSurveyPage().iaSurvey.createSurveyAndTypeSurveyName( surveyName )
                                                   .selectSurveyFolders( surveyType1,
                                                                         eventFolderWithSponsor ).iaQuestion.editFTQAndMapItToEmail( false )
                                                                                                            .addFTQAndMapItToLastName( false )
    ...
    public void successfullyLogHighestIDQuestionEnteredValueToCrmDuplicatedQuestionMappingsSamePageAndTwoNotMappedMCQCampaignResponses() throws Exception {
        ...
        try {
            ...
            par.lastName.add( duplicatedFTQids.get( send.msdSurvey.dynamicQuestion.getHighesQuestionId( duplicatedFTQids ) ) );
    ...
    public void successfullyCompleteSurveyWithOneMappedMCQAndMCQMappedOnlyToCampaignResponse() throws Exception {
        ...
        try {
            ...
            loginToSend().goToSurveyPage().iaSurvey.createSurveyAndTypeSurveyName( surveyName )
                                                   .selectSurveyFolders( surveyType1,
                                                                         eventFolderWithSponsor ).iaQuestion.editQuestionType( "A free text question" )
                                                                                                            .enterQuestion( FTcontactField.EMAIL.question )
                                                                                                            .mapFtQuestionToContactField( FTcontactField.EMAIL.conntactFiled )
                                                                                                            .updateQuestion()
                                                                                                            .addNewQuestionType( "Free Text",
