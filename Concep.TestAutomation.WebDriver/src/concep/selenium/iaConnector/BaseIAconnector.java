...
public class BaseIAconnector {
	...
	protected BaseIAconnector addEmailConfirmation() throws Exception {
	...
	protected BaseIAconnector addEmailConfirmationContactMappings(
	...
	protected BaseIAconnector createContactIaCRM(String emailAddress,
	...
	protected BaseIAconnector verifyCampaignIsSuccessfullySent(
	...
	protected BaseIAconnector logIaContactDetails(String iaContactLastName,
