...
public class SurveyTemplate extends BaseIA{
	...
	private boolean verifyTemplatesExistance(String[] templateNames) throws Exception {
	...
	private SurveyTemplate createOnePageTemplate() throws Exception {
		...
		send.iaSurvey.iaQuestion.editQuestionType( "A free text question" )
                                ...
                                .updateQuestion()
                                .addOrUpdateMCQuestionBy( MCcontactFiled.GENDERGLOBAL.question, QuestionStatus.NEW )
                                .fillinMCQAnswers( MCcontactFiled.GENDERGLOBAL.option_1, MCcontactFiled.GENDERGLOBAL.option_2 )
                                .mapMcQuestionToContactField( MCcontactFiled.GENDERGLOBAL )
                                .updateQuestion()
                                .addOrUpdateMCQuestionBy( MCcontactFiled.COLORLOCAL.question, QuestionStatus.NEW )
                                .fillinMCQAnswers( MCcontactFiled.COLORLOCAL.option_1, MCcontactFiled.COLORLOCAL.option_2 )
	...
	private SurveyTemplate createThreePagesTemplate() throws Exception {
		...
		send.iaSurvey.goToPageInSurvey("Page 2")
						        ...
						        .mapMcQuestionToContactField( MCcontactFiled.GENDERGLOBAL )
						        .updateQuestion();
		send.iaSurvey.addAndGoToPage( "Page 3" ).iaQuestion
						        .addOrUpdateMCQuestionBy( MCcontactFiled.COLORLOCAL.question, QuestionStatus.NEW )
						        .fillinMCQAnswers( MCcontactFiled.COLORLOCAL.option_1, MCcontactFiled.COLORLOCAL.option_2 )
						        .mapMcQuestionToContactField( MCcontactFiled.COLORLOCAL )
						        .updateQuestion();
	...
	private SurveyTemplate verifySurveyTemplateOnePageContent() throws Exception {
    	...
    	send.verifyDisplayedElements(new String[] {element.iaEventFolderDropDown_2,
												   ...
												   element.getSurveyMCQAnswerOption(MCcontactFiled.GENDERGLOBAL.question, MCcontactFiled.GENDERGLOBAL.option_1),
												   element.getSurveyMCQAnswerOption(MCcontactFiled.GENDERGLOBAL.question, MCcontactFiled.GENDERGLOBAL.option_2),
												   element.getSurveyMCQcontentText(MCcontactFiled.COLORLOCAL.question),
												   element.getSurveyMCQAnswerOption(MCcontactFiled.COLORLOCAL.question, MCcontactFiled.COLORLOCAL.option_1),
												   element.getSurveyMCQAnswerOption(MCcontactFiled.COLORLOCAL.question, MCcontactFiled.COLORLOCAL.option_2)},
	...
	private SurveyTemplate verifySurveyTemplateMappingsOnePage() throws Exception {
        ...
        send.verifyDisplayedElements(new String[] {element.getFreeTextQuestionMappingIndicator(FTcontactField.PRIMARYEMAIL.question, FTcontactField.PRIMARYEMAIL.conntactFiled),
        										   ...
        										   element.getMultipleChoiceQUesitonMappingIndicator(MCcontactFiled.GENDERGLOBAL.question, MCcontactFiled.GENDERGLOBAL.name),
        										   element.getMultipleChoiceQUesitonMappingIndicator(MCcontactFiled.COLORLOCAL.question, MCcontactFiled.COLORLOCAL.name)},
	 ...
	 private SurveyTemplate mapSurveyTemplateThreePages() throws Exception {
	    	...
	    	send.iaSurvey.goToPageInSurvey("Page 1").
	    		           iaQuestion.editQuestionType(MCcontactFiled.GENDER.question).
	    		           mapMcQuestionToContactField( MCcontactFiled.GENDER ).
					       updateQuestion().
	 ...
	 private SurveyTemplate verifySurveyTemplateMappingsThreePages() throws Exception {
	    	...
	    	send.verifyDisplayedElements(new String[] {element.getMultipleChoiceQUesitonMappingIndicator(MCcontactFiled.COLORLOCAL.question, MCcontactFiled.COLORLOCAL.name)},
    ...
    public void successfullyCreateSurveyWithTemplateQuestionsOnePage() throws Exception {
        ...
        try {
        	...
        	loginToSend().goToSurveyPage().iaSurvey.startCreatingSurveyUsingTemplate(surveyTemplateOnePage, surveyName).
    ...
    public void successfullyCreateSurveyWithTemplateQuestionsThreePages() throws Exception {
        ...
        try {
        	...
        	loginToSend().goToSurveyPage().iaSurvey.startCreatingSurveyUsingTemplate(surveyTemplateThreePages, surveyName).
        	selectSurveyFolders( surveyType1, eventFolderWithSponsor );
    ...
    public void successfullyCompleteSurveyWithTemplateQuestionsOnePage() throws Exception {
        ...
        try {
           ...
           loginToSend().goToSurveyPage().iaSurvey.startCreatingSurveyUsingTemplate(surveyTemplateOnePage, surveyName).
       	   selectSurveyFolders( surveyType1, eventFolderWithSponsor );
           verifySurveyTemplateOnePageContent().mapSurveyTemplateOnePage();
           send.iaSurvey.saveAndSelectTheme( Theme.TABLE.type ).viewAndDeployTheSurvey().iaQuestion.answerMcQuestion( MCcontactFiled.GENDER.question,
																									 	                    new String[]{ MCcontactFiled.GENDER.option_1 } )
																										 .answerFtQuestion( FTcontactField.PRIMARYEMAIL.question, emailAddress )
        ...
        try {
           ...
           send.iaSurvey.saveAndSelectTheme( Theme.TABLE.type ).viewAndDeployTheSurvey().iaQuestion.answerMcQuestion( MCcontactFiled.GENDER.question,
																										 ...
																										 .answerMcQuestion( MCcontactFiled.GENDERGLOBAL.question,
																							 	         ...
																							 	         .answerMcQuestion( MCcontactFiled.COLORLOCAL.question,
																							 	                            new String[]{ MCcontactFiled.COLORLOCAL.option_1 } )
																							 	         .answerFtQuestion( FTcontactField.COMPANY.question, companyName);
    ...
    public void successfullyCompleteSurveyWithTemplateQuestionsThreePages() throws Exception {
        ...
        try {
           ...
           send.iaSurvey.saveAndSelectTheme( Theme.TABLE.type ).viewAndDeployTheSurvey().iaQuestion.answerMcQuestion( MCcontactFiled.GENDER.question,
																										 ...
																										 .answerFtQuestion( FTcontactField.PRIMARYEMAIL.question, emailAddress )
																										 .answerFtQuestion( FTcontactField.FIRSTNAME.question, firstName );
           													  send.iaSurvey.surveyNext().iaQuestion.answerFtQuestion( FTcontactField.LASTNAME.question, lastName )
																										 .answerMcQuestion( MCcontactFiled.GENDERGLOBAL.question,
																							 	                            new String[]{ MCcontactFiled.GENDERGLOBAL.option_1 } );
    ...
    public void successfullyDeleteSurveyTemplate() throws Exception {
        ...
        try {
        	 ...
        	 send.logOut().typeInUserName(iaSendUser).typeInPassword(iaSendPassword).loginSendButton().goToSurveyPage().iaSurvey.startSurveyCreation();        	 
