...
public class SurveyCreation extends BaseIA {

    private String  sourceFolder              = "Firm Contacts - Companies";
    private boolean isSourced                 = true;
    private String  warningMessageForEmail    = "In order to log responses in your CRM system, E-Mail must be mapped. Please map a question to this contact field and try again.";
    private String  warningMessageForLastName = "Sorry! We noticed you have not mapped the Last Name field.";
    private String  defaultDropdownValue      = "Please select";
    private String  emailContactFieldMapping  = "Primary Email";
