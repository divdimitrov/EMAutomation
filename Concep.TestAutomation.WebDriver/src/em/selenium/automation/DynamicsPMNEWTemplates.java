...
public class DynamicsPMNEWTemplates {
	
		private GenericSeleniumWebDriver driver;
	    private LogResults               log     = new LogResults();
	    private ElementsAdminPage                 element = new ElementsAdminPage();
	    private ElementsDynamicsPMNEWTemplates         elementDynamics = new ElementsDynamicsPMNEWTemplates();

	    public DynamicsPMNEWTemplates() {

	        this.driver = DriverAccessor.getDriverInstance();
	    }
	    

	    public DynamicsPMNEWTemplates accessDynamics() throws Exception {
	   ...
	   public DynamicsPMNEWTemplates searchCustomerEmail(
	   ...
	   public DynamicsPMNEWTemplates verifyDisplayedContact(
	   ...
	   public DynamicsPMNEWTemplates verifyDisplayedElementsDynamics(
	   ...
	   public DynamicsPMNEWTemplates verifyDisplayedElementsInIFrame(
	   ...
	   public DynamicsPMNEWTemplates openFoundContact() {
	   ...
	   protected DynamicsPMNEWTemplates actionDynamics(
